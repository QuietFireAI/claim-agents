---
name: 03-policy-verification
description: "Policy verification. Use when a claim needs policy-record facts on the date of loss: status, limits, deductibles, endorsements - facts only, never coverage opinions."
---
...
{
  "envelope_id": "uuid",
  "from_agent": "03-policy-verification",
