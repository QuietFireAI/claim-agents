---
name: 01-fnol-intake
description: "First notice of loss intake. Use when a new loss is reported on any channel and needs complete, source-attributed FNOL capture with injury/habitability flags - no coverage statements, ever."
---
