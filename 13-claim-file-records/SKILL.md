---
name: 13-claim-file-records
description: "Claim file and records. Use when interactions need the append-only claim file, record lookups need verbatim answers, or chronologies are needed for regulatory packages and books."
---
...
{
  "envelope_id": "uuid",
  "from_agent": "13-claim-file-records",
