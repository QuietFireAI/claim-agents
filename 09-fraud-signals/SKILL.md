---
name: 09-fraud-signals
description: "Fraud signals. Use when indicator observations need aggregation, scoring against the ratified list, or SIU referral-package preparation - observation only, never accusation, never delay."
---
